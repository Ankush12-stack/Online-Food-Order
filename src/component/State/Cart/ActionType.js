...
export const GET_ALL_CART_ITEMS_REQUEST = 'GET_ALL_CART_REQUEST';
export const GET_ALL_CART_ITEMS_SUCCESS = 'GET_ALL_CART_SUCCESS';
export const GET_ALL_CART_ITEMS_FAILURE = 'GET_ALL_CART_FAILURE';
